...
describe('Monster', function () {
  ...
  beforeEach(function() {
    ...
    monsters = [
      ...
      { name: 'Dragon', difficulty: 'boss', specialAttack:'Black Flame', specialAttackDamage: 10, health: 300, armor: 6, strength: 13, dexterity: 8, weaponMin: 15, weaponMax: 22, stunStatus: false, image: './static/images/dragon.png' },
